    ...
    <div class="dash">
        <div class="dash-nav dash-nav-dark">
            <header>
                ...
                <a href="index.html" class="spur-logo"><i class="fas fa-copyright"></i> <span>Team Move</span></a>
            </header>
            <nav class="dash-nav-list">
                ...
                <a href="community.html" class="dash-nav-item">
                    <i class="fas fa-business-time"></i> Community Enter. </a>
                <div class="dash-nav-dropdown">
                    <a href="#!" class="dash-nav-item dash-nav-dropdown-toggle">
                        <i class="fas fa-chart-bar"></i> Charts </a>
                    <div class="dash-nav-dropdown-menu">
                        <a href="commCharts.html" class="dash-nav-dropdown-item">Chart.js</a>
                    </div>
                </div>
                <div class="dash-nav-dropdown ">
                    <a href="#!" class="dash-nav-item dash-nav-dropdown-toggle">
                    ...
                    <div class="dash-nav-dropdown-menu">
                        ...
                        <a href="commtables.html" class="dash-nav-dropdown-item">Tables</a>
                    ...
                    <div class="row dash-row">
                        <div class="col-xl-4">
                            <div class="stats stats-primary">
                                <h3 class="stats-title"> Total number of projects </h3>
                        ...
                        <div class="col-lg-4">
                            <div class="stats stats-success">
                                <h3 class="stats-title"> Total number of students </h3>
                                <div class="stats-content">
                                    <div class="stats-icon">
                        ...
                        <div class="col-lg-4">
                            <div class="stats stats-info">
                                <h3 class="stats-title"> Student oragnised activities(total) </h3>
                                <div class="stats-content">
                                    <div class="stats-icon">
                        ...
                        <div class="col-xl-4">
                            <div class="stats stats-danger">
                                <h3 class="stats-title"> Number of business models </h3>
                                <div class="stats-content">
                                    <div class="stats-icon">
